...
In diesem Design wird das Entwicklerboard dazu benötigt, die TDC7200 ICs zu bedienen. Dazu wird ein \acrfull{spi}
verwendet, um die Mess-ICs zu konfigurieren und auszulesen (in der Abbildung als \acrshort{spi}-Bus zusammengefasst).
