...
\newcommand{\vAbstract}{
    ...
    Ein \acrfull{tdc} wird eingesetzt, um die Signallaufzeit präzise zu messen. Zu Testzwecken wird
    ein zweiter \acrshort{tdc} eingesetzt, der rein elektrisch betrieben wird, um die Länge unterschiedlicher
    Kupferkabel zu bestimmen.
