...
\begin{itemize}
    \item \textbf{Kapitel~\ref{sec:theory} - \nameref{sec:theory}:} Befasst sich mit den theoretischen Grundlagen,
          welche für die Entwicklung des Demonstrators erarbeitet wurden.

    \item \textbf{Kapitel~\ref{sec:concept} - \nameref{sec:concept}:} Erklärt die groben Konzepte und Herausforderungen,
    ...
    \item \textbf{Kapitel~\ref{sec:simulations} - \nameref{sec:simulations}:} Beinhaltet Informationen zu den
          Simulationen, welche vor dem Design aber auch während der Inbetriebnahme des Demonstrators durchgeführt werden.

    \item \textbf{Kapitel~\ref{sec:realisation} - \nameref{sec:realisation}:} Erläutert die Umsetzung in die Realität.
    ...
    \item \textbf{Kapitel~\ref{sec:results} - \nameref{sec:results}:} Dokumentiert sämtliche durchgeführte Messungen
          sowie deren Resultate. Hier ist ersichtlich, inwiefern die initiale Zielsetzung erreicht wurde.

    \item \textbf{Kapitel~\ref{sec:conclusion} - \nameref{sec:conclusion}:} Erfasst abschliessende Gedanken der
