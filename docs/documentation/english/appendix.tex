...
\subsection{TDC Driver}\label{sec:tdc_driver}

The code in \ref{code:tdc_driver_header} and \ref{code:tdc_driver_source} shows the firmware driver developed in-house
for the \acrshort{tdc}.
...
\subsection{Python Scripts}\label{sec:python_scripts}

The Python script for calculating the arithmetic mean and the standard deviation, as well as for plotting the histogram
and the box plot, is shown in code \ref{code:python_analyze}.

\lstinputlisting[language={python}, label={code:python_analyze}, caption={Python Analysis}]{../../../utilities/analyze-tof.py}

The Python script for calculating the arithmetic mean and standard deviation and for plotting the values for several
\acrshort{tof} data sets is shown in code \ref{code:python_analyze_multi_tofs}.

\lstinputlisting[language={python}, label={code:python_analyze_multi_tofs}, caption={Python Analysis (Multi \acrshort{tof}s)}]{../../../utilities/analyze-tofs.py}

The Python script for plotting the values from several log files is shown in code \ref{code:python_analyze_multi_logs}.

\lstinputlisting[language={python}, label={code:python_analyze_multi_logs}, caption={Python Analysis (Multi Logs)}]{../../../utilities/analyze-tofs-multi-logs.py}

The Python script for live plotting of \acrshort{tof} values is shown in code \ref{code:python_live_plot}. This will be
used during the presentation for demonstration purposes.
...
\begin{figure}[H]
    ...
    \caption{PCB Layout Inner 1}\label{fig:apdx_pcb_in1_cu}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[trim=130 220 450 80, clip, width=0.6\textwidth]{../attachments/pcb_In2_Cu.pdf}
    \caption{PCB Layout Inner 2}\label{fig:apdx_pcb_in2_cu}
\end{figure}
...
\subsection{Photos of the demonstrator}\label{sec:apdx_photos_demonstrator}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../graphics/photo_demonstrator_top.jpg}
    \caption{Demonstrator from above}\label{fig:apdx_photo_demonstrator_top}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../graphics/photo_demonstrator_top_wo_lens.jpg}
    \caption{Demonstrator from above without lens}\label{fig:apdx_photo_demonstrator_top_wo_lens}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../graphics/photo_demonstrator_front.jpg}
    \caption{Demonstrator from the front}\label{fig:apdx_photo_demonstrator_front}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../graphics/photo_demonstrator_front_wo_lens.jpg}
    \caption{Demonstrator from the front without lens}\label{fig:apdx_photo_demonstrator_front_wo_lens}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../graphics/photo_demonstrator_bottom.jpg}
    \caption{Demonstrator from below}\label{fig:apdx_photo_demonstrator_bottom}
\end{figure}
