...
\lstdefinestyle{mystyle}{
    ...
    showtabs=false,
    tabsize=4,
    morekeywords={int8_t, uint8_t, int16_t, uint16_t, int32_t, uint32_t, bool, true, false},
...
\newcommand{\codehighlight}[5][\ttfamily\scriptsize]
{
    \ifnum#3>1
        ...
        \vspace{-12pt}
    \fi
    \lstinputlisting[firstnumber=#3, firstline=#3, lastline=#4, language=#2, basicstyle=#1, showlines=true]{#5}
    \vspace{-12pt}
