...
\textcolor{red}{Signalkette erklären: Puls -> Gate-Treiber-> Laser -> Luft -> PD -> TIA -> Comp.}
...
\textcolor{red}{TODO: Evtl erwähnen, nicht, dass jetzt falsche Erwartungen entstehen:}
...
die Schaltzeit des Komparators eine grosse Rolle.

\subsection{Vorangehensweise}
\textcolor{red}{TODO: Erklären, warum wir 2 TDCs einsetzen}
